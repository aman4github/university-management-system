...
export default function ViewResultBca3rd() {
        ...
        <table >
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{(parseInt(student.it) + parseInt(student.java) + parseInt(student.c))}/300</td>
            </tr>
