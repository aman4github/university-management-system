...
export default function ViewResultBca4th() {
      ...
      <div className="outer-table detailsTable">
        ...
        <table >
          ...
          <tbody>
            ...
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - FLASK</td>
              <td>{student.flask}/100</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - DJANGO</td>
              <td>{student.django}/100</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - WEBDEV</td>
              <td>{student.webdev}/100</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Total</td>
              <td>{(parseInt(student.flask) + parseInt(student.django) + parseInt(student.webdev))}/300</td>
            </tr>
