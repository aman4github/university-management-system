...
export default function ViewResultBba2nd() {
      ...
      <div className="outer-table detailsTable">
        ...
        <table >
          ...
          <tbody>
            ...
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - SOFTWARE LAB</td>
              <td>{student.softwarelab}/100</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - BUSINESS ACCOUNTING</td>
              <td>{student.businessaccounting}/100</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - BUSINESS LAW</td>
              <td>{student.businesslaw}/100</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Total</td>
              <td>{(parseInt(student.softwarelab) + parseInt(student.businessaccounting) + parseInt(student.businesslaw))}/300</td>
            </tr>
