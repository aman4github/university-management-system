...
export default function ViewResultBhm4th() {
  ...
  const loaddata = async () => {
    const id = localStorage.getItem("id");
    await fetch(`http://127.0.0.1:8081/viewResult4th?id=` + id, {
      method: 'GET',
      headers: {
      ...
      <div className="outer-table detailsTable">
        ...
        <table >
          ...
          <tbody>
            ...
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - HR-MANAGEMENT</td>
              <td>{student.hrmanagement}/100</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - PUBLIC-RELATIONS</td>
              <td>{student.publicrelations}/100</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - FOOD-SCIENCE</td>
              <td>{student.foodscience}/100</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Total</td>
              <td>{(parseInt(student.hrmanagement) + parseInt(student.publicrelations) + parseInt(student.foodscience))}/300</td>
            </tr>
