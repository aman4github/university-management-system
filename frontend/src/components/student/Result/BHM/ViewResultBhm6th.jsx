...
export default function ViewResultBhm6th() {
  ...
  const loaddata = async () => {
    const id = localStorage.getItem("id");
    await fetch(`http://127.0.0.1:8081/viewResult6th?id=` + id, {
      method: 'GET',
      headers: {
      ...
      <div className="outer-table detailsTable">
        ...
        <table >
          ...
          <tbody>
            ...
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - HUMAN RESOURCES</td>
              <td>{student.humanresources}/100</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - HOTEL LAW</td>
              <td>{student.hotellaw}/100</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - INTERNATIONAL BANKING</td>
              <td>{student.internationalbaking}/100</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Total</td>
              <td>{(parseInt(student.humanresources) + parseInt(student.hotellaw) + parseInt(student.internationalbaking))}/300</td>
            </tr>
