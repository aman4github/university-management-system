...
export default function ViewResultBhm2nd() {
  ...
  const loaddata = async () => {
    const id = localStorage.getItem("id");
    await fetch(`http://127.0.0.1:8081/viewResult2nd?id=` + id, {
      method: 'GET',
      headers: {
      ...
      <div className="outer-table detailsTable">
        ...
        <table >
          ...
          <tbody>
            ...
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - OPERATIONS</td>
              <td>{student.operations}/100</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - HOSPITALITY SERVICES</td>
              <td>{student.hospitalityservices}/100</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - CUSTOMER SERVICE</td>
              <td>{student.customerservice}/100</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Total</td>
              <td>{(parseInt(student.operations) + parseInt(student.hospitalityservices) + parseInt(student.customerservice))}/300</td>
            </tr>
