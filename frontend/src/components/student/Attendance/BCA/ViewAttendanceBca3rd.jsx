...
export default function ViewAttendanceBca3rd() {
      ...
      <div className="outer-table detailsTable">
        ...
        <table >
          ...
          <tbody>
            ...
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - INOFRMATION TECHNOLOGY</td>
              <td>Presented - {student.it}/{total.itattended} Days</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - JAVA</td>
              <td>Presented - {student.java}/{total.javaattended} Days</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - C LANGUAGE</td>
              <td>Presented - {student.c}/{total.cattended} Days</td>
            </tr>
