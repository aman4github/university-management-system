...
export default function ViewAttendanceBhm5th() {
      ...
      <div className="outer-table detailsTable">
        ...
        <table >
          ...
          <tbody>
            ...
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - SOFT SKILLS</td>
              <td>Presented - {student.softskills}/{total.softskillsattended} Days</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - NUTRITION</td>
              <td>Presented - {student.nutrition}/{total.nutritionattended} Days</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - FOOD SAFETY</td>
              <td>Presented - {student.foodsafety}/{total.foodsafetyattended} Days</td>
            </tr>
