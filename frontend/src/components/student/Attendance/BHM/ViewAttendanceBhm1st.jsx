...
export default function ViewAttendanceBhm1st() {
      ...
      <div className="outer-table detailsTable">
        ...
        <table >
          ...
          <tbody>
            ...
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - Kitchen Services</td>
              <td>Presented - {student.kitchenservices}/{total.kitchenservicesattended} Days</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - Food Preparation</td>
              <td>Presented - {student.foodpreparation}/{total.foodpreparationattended} Days</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - Catering Sciences</td>
              <td>Presented - {student.cateringsciences}/{total.cateringsciencesattended} Days</td>
            </tr>
