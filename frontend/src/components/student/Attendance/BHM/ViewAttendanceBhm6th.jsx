...
export default function ViewAttendanceBhm6th() {
        ...
        <table >
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Presented - {student.humanresources}/{total.humanresourcesattended} Days</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - HOTEL LAW</td>
              <td>Presented - {student.hotellaw}/{total.hotellawattended} Days</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - INTERNATIONAL BAKING</td>
              <td>Presented - {student.internationalbaking}/{total.internationalbakingattended} Days</td>
            </tr>
