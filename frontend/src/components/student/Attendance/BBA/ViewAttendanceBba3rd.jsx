...
export default function ViewAttendanceBba3rd() {
      ...
      <div className="outer-table detailsTable">
        ...
        <table >
          ...
          <tbody>
            ...
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - MACRO ECONOMICS</td>
              <td>Presented - {student.macroeconomics}/{total.macroeconomicsattended} Days</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - FINANCIAL ACCOUNTING</td>
              <td>Presented - {student.financialaccounting}/{total.financialaccountingattended} Days</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - CONSUMER BEHAVIOUR</td>
              <td>Presented - {student.consumerbehaviour}/{total.consumerbehaviourattended} Days</td>
            </tr>
