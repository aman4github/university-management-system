...
export default function ViewAttendanceBba2nd() {
      ...
      <div className="outer-table detailsTable">
        ...
        <table >
          ...
          <tbody>
            ...
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - MANAGEMENT</td>
              <td>Presented - {student.management}/{total.managementattended} Days</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - SALES</td>
              <td>Presented - {student.sales}/{total.salesattended} Days</td>
            </tr>
            <tr>
              <td className="detailsTd" style={{ backgroundColor: "#BA68C8", color: "white", borderRadius: "15px" }}>Subject - RETAIL MANAGEMENT</td>
              <td>Presented - {student.retailmanagement}/{total.retailmanagementattended} Days</td>
            </tr>
