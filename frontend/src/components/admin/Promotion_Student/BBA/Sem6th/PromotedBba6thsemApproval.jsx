...
export default function PromotedBba6thsemApproval() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        ...
        // setTimeout(() => {
        //     window.location.href = "http://localhost:3000/promoteBba6thSem";
        // }, 2000);
        navigate("/promoteBba6thSem");
    }
