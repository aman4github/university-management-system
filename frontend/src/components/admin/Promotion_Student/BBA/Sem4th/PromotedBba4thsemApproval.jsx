...
export default function PromotedBba4thsemApproval() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        ...
        await addStudent5thSem({id: id, stream: "BBA", sem: "5TH"});
        Swal.fire({
            title: 'Success...',
        ...
        // setTimeout(() => {
        //     window.location.href = "http://localhost:3000/promoteBba4thSem";
        // }, 2000);
        navigate("/promoteBba4thSem");
    }
