...
export default function PromotedBca6thsemApproval() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        ...
        // setTimeout(() => {
        //     window.location.href = "http://localhost:3000/promoteBca6thSem";
        // }, 2000);
        navigate("/promoteBca6thSem");
    }
