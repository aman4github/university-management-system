...
export default function PromotedBca1stsemApproval() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        ...
        await addStudent2ndSem({id: id, stream: "BCA", sem: "2ND"});
        Swal.fire({
            title: 'Success...',
        ...
        // setTimeout(() => {
        //     window.location.href = "http://localhost:3000/promoteBca1stSem";
        // }, 2000);
        navigate("/promoteBca1stSem");
    }
