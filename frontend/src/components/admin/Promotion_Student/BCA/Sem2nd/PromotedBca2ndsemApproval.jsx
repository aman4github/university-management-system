...
export default function PromotedBca2ndsemApproval() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        ...
        await addStudent3rdSem({id: id, stream: "BCA", sem: "3RD"});
        Swal.fire({
            title: 'Success...',
        ...
        // setTimeout(() => {
        //     window.location.href = "http://localhost:3000/promoteBca2ndSem";
        // }, 2000);
        navigate("/promoteBca2ndSem");
    }
