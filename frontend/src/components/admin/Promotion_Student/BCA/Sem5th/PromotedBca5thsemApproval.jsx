...
export default function PromotedBca5thsemApproval() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        ...
        await addStudent6thSem({id: id, stream: "BCA", sem: "6TH"});
        Swal.fire({
            title: 'Success...',
        ...
        // setTimeout(() => {
        //     window.location.href = "http://localhost:3000/promoteBca5thSem";
        // }, 2000);
        navigate("/promoteBca5thSem");
    }
