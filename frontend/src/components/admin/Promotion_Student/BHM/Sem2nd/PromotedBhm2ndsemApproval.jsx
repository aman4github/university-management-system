...
export default function PromotedBhm2ndsemApproval() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        ...
        await addStudent3rdSem({id: id, stream: "BHM", sem: "3RD"});
        Swal.fire({
            title: 'Success...',
        ...
        // setTimeout(() => {
        //     window.location.href = "http://localhost:3000/promoteBhm2ndSem";
        // }, 2000);
        navigate("/promoteBhm2ndSem");
    }
