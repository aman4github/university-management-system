...
export default function PromotedBhm5thsemApproval() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        ...
        await addStudent6thSem({id: id, stream: "BHM", sem: "6TH"});
        Swal.fire({
            title: 'Success...',
        ...
        // setTimeout(() => {
        //     window.location.href = "http://localhost:3000/promoteBhm5thSem";
        // }, 2000);
        navigate("/promoteBhm5thSem");
    }
