...
export default function PromotedBhm4thsemApproval() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        ...
        await addStudent5thSem({id: id, stream: "BHM", sem: "5TH"});
        Swal.fire({
            title: 'Success...',
        ...
        // setTimeout(() => {
        //     window.location.href = "http://localhost:3000/promoteBhm4thSem";
        // }, 2000);
        navigate("/promoteBhm4thSem");
    }
