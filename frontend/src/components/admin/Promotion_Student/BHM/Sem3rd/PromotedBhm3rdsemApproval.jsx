...
export default function PromotedBhm3rdsemApproval() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        ...
        await addStudent4thSem({id: id, stream: "BHM", sem: "4TH"});
        Swal.fire({
            title: 'Success...',
        ...
        // setTimeout(() => {
        //     window.location.href = "http://localhost:3000/promoteBhm3rdSem";
        // }, 2000);
        navigate("/promoteBhm3rdSem");
    }
