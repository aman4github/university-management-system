...
export default function PromotedBhm1stsemApproval() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        ...
        await addStudent2ndSem({id: id, stream: "BHM", sem: "2ND"});
        Swal.fire({
            title: 'Success...',
        ...
        // setTimeout(() => {
        //     window.location.href = "http://localhost:3000/promoteBhm1stSem";
        // }, 2000);
        navigate("/promoteBhm1stSem");
    }
