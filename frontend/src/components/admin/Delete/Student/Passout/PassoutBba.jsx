...
import { getAllStudentByStreamPassoutBba } from '../../../../../Services/student_api'
import { Link } from 'react-router-dom';

export default function PassoutBba() {
    ...
    const loadStudents = async () => {
        const studentResult = await getAllStudentByStreamPassoutBba();
                            ...
                            students.map((student) => {
                                return (
                                    <tr>
                                        ...
                                        <td>
                                            <Link to={`/PassoutBbaConfirmation/${student.id}`}>
