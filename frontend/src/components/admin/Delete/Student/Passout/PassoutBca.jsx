...
import { getAllStudentByStreamPassoutBca } from '../../../../../Services/student_api'
import { Link } from 'react-router-dom';

export default function PassoutBca() {
    ...
    const loadStudents = async () => {
        const studentResult = await getAllStudentByStreamPassoutBca();
                            ...
                            students.map((student) => {
                                return (
                                    <tr>
                                        ...
                                        <td>
                                            <Link to={`/PassoutBcaConfirmation/${student.id}`}>
