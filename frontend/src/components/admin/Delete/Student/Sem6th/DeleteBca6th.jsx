...
export default function DeleteBca6th() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        ...
        // setTimeout(() => {
        //     window.location.href = "http://localhost:3000/adminallStudentDeleteBCA6th";
        // }, 2000);
        navigate("/adminallStudentDeleteBCA6th");
    }
            ...
            <div className="wrapper">
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="buttonsConfirmation">
                        ...
                        <Link to="/adminallStudentDeleteBCA6th">
