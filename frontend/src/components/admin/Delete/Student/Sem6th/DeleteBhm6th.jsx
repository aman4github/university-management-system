...
export default function DeleteBhm6th() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        ...
        // setTimeout(() => {
        //     window.location.href = "http://localhost:3000/adminallStudentDeleteBHM6th";
        // }, 2000);
        navigate("/adminallStudentDeleteBHM6th");
    }
            ...
            <div className="wrapper">
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="buttonsConfirmation">
                        ...
                        <Link to="/adminallStudentDeleteBHM6th">
