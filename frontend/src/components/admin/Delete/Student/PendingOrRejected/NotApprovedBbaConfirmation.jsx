...
export default function NotApprovedBbaConfirmation() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        ...
        // setTimeout(() => {
        //     window.location.href = "http://localhost:3000/NotApprovedBba";
        // }, 2000);
        navigate("/NotApprovedBba");
    }
