...
export default function NotApprovedBcaConfirmation() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        ...
        // setTimeout(() => {
        //     window.location.href = "http://localhost:3000/NotApprovedBca";
        // }, 2000);
        navigate("/NotApprovedBca");
    }
