...
export default function NotApprovedBhmConfirmation() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        ...
        // setTimeout(() => {
        //     window.location.href = "http://localhost:3000/NotApprovedBhm";
        // }, 2000);
        navigate("/NotApprovedBhm");
    }
