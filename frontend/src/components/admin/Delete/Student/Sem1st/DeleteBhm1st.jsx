...
export default function DeleteBhm1st() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        ...
        // setTimeout(() => {
        //     window.location.href = "http://localhost:3000/adminallStudentDeleteBHM1st";
        // }, 2000);
        navigate("/adminallStudentDeleteBHM1st");
    }
            ...
            <div className="wrapper">
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="buttonsConfirmation">
                        ...
                        <Link to="/adminallStudentDeleteBHM1st">
