...
export default function DeleteBca1st() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        ...
        // setTimeout(() => {
        //     window.location.href = "http://localhost:3000/adminallStudentDeleteBCA1st";
        // }, 2000);
        navigate("/adminallStudentDeleteBCA1st");
    }
            ...
            <div className="wrapper">
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="buttonsConfirmation">
                        ...
                        <Link to="/adminallStudentDeleteBCA1st">
