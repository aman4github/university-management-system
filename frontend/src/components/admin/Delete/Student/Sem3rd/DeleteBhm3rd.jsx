...
export default function DeleteBhm3rd() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        ...
        // setTimeout(() => {
        //     window.location.href = "http://localhost:3000/adminallStudentDeleteBHM3rd";
        // }, 2000);
        navigate("/adminallStudentDeleteBHM3rd");
    }
            ...
            <div className="wrapper">
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="buttonsConfirmation">
                        ...
                        <Link to="/adminallStudentDeleteBHM3rd">
