...
export default function BbaNoticeDeleteConfirmation() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        ...
        // setTimeout(() => {
        //     window.location.href = "http://localhost:3000/BbaNoticeDelete";
        // }, 2000);
        navigate("/BbaNoticeDelete");
    }
