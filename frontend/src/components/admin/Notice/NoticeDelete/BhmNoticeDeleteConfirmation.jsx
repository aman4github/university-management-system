...
export default function BhmNoticeDeleteConfirmation() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        ...
        // setTimeout(() => {
        //     window.location.href = "http://localhost:3000/BhmNoticeDelete";
        // }, 2000);
        navigate("/BhmNoticeDelete");
    }
