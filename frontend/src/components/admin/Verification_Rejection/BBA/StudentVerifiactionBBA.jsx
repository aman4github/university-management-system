...
export default function StudentVerifiactionBBA(props) {
                            ...
                            students.map((student) => {
                                return (
                                    <tr>
                                        ...
                                        <td>
                                            <Link to={`/editStudentApprovedBBA/${student.id}/${student.email}`}>
                                                <button type="button" class="btn btn-success btnAction">Approve</button>
                                            </Link>
                                            <Link to={`/editStudentRejectedBBA/${student.id}/${student.email}`}>
