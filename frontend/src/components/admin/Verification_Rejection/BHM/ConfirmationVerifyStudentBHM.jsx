...
export default function ConfirmationVerifyStudentbca() {
    ...
    const onSubmit = async (e) => {
        ...
        await addStudentAttandance({
            id: id, stream: "BHM", sem: "1ST",
            kitchenservices: "0", foodpreparation: "0", cateringsciences: "0",
            operations: "0", hospitalityservices: "0", customerservice: "0",
            leadershipskills: "0", housekeeping: "0", tourismmarketing: "0",
            hrmanagement: "0", publicrelations: "0", foodscience: "0",
            softskills: "0", nutrition: "0", foodsafety: "0",
            humanresources: "0", hotellaw: "0", internationalbaking: "0",
        });
        await addStudent1stSem({ id: id, stream: "BHM", sem: "1ST" });
        navigate("/studentVerificationBHM");
    }
            ...
            <div className="wrapper">
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="buttonsConfirmation">
                        <button type="submit" className="yesConfirm" onClick={() => {setStudent({ status: "APPROVED", sem: "1ST" });sendMail(email)}}>
                            Yes
                        </button>
                        <Link to="/studentVerificationBHM">
