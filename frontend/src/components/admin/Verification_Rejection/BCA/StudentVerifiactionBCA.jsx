...
export default function StudentVerifiactionBCA(props) {
                            ...
                            students.map((student) => {
                                return (
                                    <tr>
                                        ...
                                        <td>
                                            <Link to={`/editStudentApprovedBCA/${student.id}/${student.email}`}>
                                                <button type="button" class="btn btn-success btnAction">Approve</button>
                                            </Link>
                                            <Link to={`/editStudentRejectedBCA/${student.id}/${student.email}`}>
