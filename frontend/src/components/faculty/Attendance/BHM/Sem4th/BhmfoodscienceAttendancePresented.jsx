...
import { addAttandanceBhmfoodscience } from '../../../../../Services/attendance_api'
import '../../../../../style/login.css'
import Swal from "sweetalert2";

export default function BhmfoodscienceAttendancePresented() {
    useEffect(() => {
    ...
    const { id, foodscience } = useParams();
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        await addAttandanceBhmfoodscience(attendance, id);
        Swal.fire({
            title: 'Success...',
            ...
            <div className="wrapper">
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="buttonsConfirmation">
                        <button type="submit" className="yesConfirm" onClick={() => setAttendance({ foodscience: parseInt(foodscience) + 1 })}>
                            Yes
                        </button>
