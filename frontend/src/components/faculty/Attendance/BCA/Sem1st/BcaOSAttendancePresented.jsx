...
import {  addAttandanceBcaOs } from '../../../../../Services/attendance_api'
import '../../../../../style/login.css'
import Swal from "sweetalert2";

export default function BcaOSAttendancePresented() {
    useEffect(() => {
    ...
    const { id, operatingsystem } = useParams();
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        await addAttandanceBcaOs(attendance, id);Swal.fire({
            title: 'Success...',
            ...
            <div className="wrapper">
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="buttonsConfirmation">
                        <button type="submit" className="yesConfirm" onClick={() => setAttendance({ operatingsystem: parseInt(operatingsystem) + 1 })}>
                            Yes
                        </button>
