...
import { addAttandanceBcaOops } from '../../../../../Services/attendance_api'
import '../../../../../style/login.css'
import Swal from "sweetalert2";

export default function BcaOOPSAttendancePresented() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        await addAttandanceBcaOops(attendance, id);Swal.fire({
            title: 'Success...',
            ...
            <div className="wrapper">
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="buttonsConfirmation">
                        <button type="submit" className="yesConfirm" onClick={() => setAttendance({ oops: parseInt(oops) + 1 })}>
                            Yes
                        </button>
