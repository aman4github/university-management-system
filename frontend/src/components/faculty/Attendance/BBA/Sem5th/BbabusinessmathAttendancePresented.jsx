...
import {  addAttandanceBbabusinessmath } from '../../../../../Services/attendance_api'
import '../../../../../style/login.css'
import Swal from "sweetalert2";

export default function BbabusinessmathAttendancePresented() {
    useEffect(() => {
    ...
    const { id, businessmath } = useParams();
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        await addAttandanceBbabusinessmath(attendance, id);
        Swal.fire({
            title: 'Success...',
            ...
            <div className="wrapper">
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="buttonsConfirmation">
                        <button type="submit" className="yesConfirm" onClick={() => setAttendance({ businessmath: parseInt(businessmath) + 1 })}>
                            Yes
                        </button>
