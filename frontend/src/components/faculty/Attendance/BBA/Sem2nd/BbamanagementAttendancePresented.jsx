...
import {  addAttandanceBbamanagement } from '../../../../../Services/attendance_api'
import '../../../../../style/login.css'
import Swal from "sweetalert2";

export default function BbamanagementAttendancePresented() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        await addAttandanceBbamanagement(attendance, id);
        Swal.fire({
            title: 'Success...',
            ...
            <div className="wrapper">
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="buttonsConfirmation">
                        <button type="submit" className="yesConfirm" onClick={() => setAttendance({ management: parseInt(management) + 1 })}>
                            Yes
                        </button>
