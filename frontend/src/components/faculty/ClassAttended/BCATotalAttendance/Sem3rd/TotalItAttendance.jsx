...
import { totalAttandanceBcaIt } from '../../../../../Services/faculty_api'
import '../../../../../style/login.css'
import Swal from "sweetalert2";

export default function TotalItAttendance() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        await totalAttandanceBcaIt(attendance, id);Swal.fire({
            title: 'Success...',
            ...
            <div className="wrapper">
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="buttonsConfirmation">
                        <button type="submit" className="yesConfirm" onClick={() => setAttendance({ itattended: parseInt(itattended) + 1 })}>
                            Yes
                        </button>
