...
import { totalAttandanceBcaC } from '../../../../../Services/faculty_api'
import '../../../../../style/login.css'
import Swal from "sweetalert2";

export default function TotalCAttendance() {
    useEffect(() => {
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        await totalAttandanceBcaC(attendance, id);
        Swal.fire({
            title: 'Success...',
            ...
            <div className="wrapper">
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="buttonsConfirmation">
                        <button type="submit" className="yesConfirm" onClick={() => setAttendance({ cattended: parseInt(cattended) + 1 })}>
                            Yes
                        </button>
