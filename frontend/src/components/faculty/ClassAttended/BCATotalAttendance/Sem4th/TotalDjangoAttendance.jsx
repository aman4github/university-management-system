...
import { totalAttandanceBcadjango } from '../../../../../Services/faculty_api'
import '../../../../../style/login.css'
import Swal from "sweetalert2";

export default function TotalDjangoAttendance() {
    useEffect(() => {
    ...
    const { id, djangoattended } = useParams();
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        await totalAttandanceBcadjango(attendance, id);Swal.fire({
            title: 'Success...',
            ...
            <div className="wrapper">
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="buttonsConfirmation">
                        <button type="submit" className="yesConfirm" onClick={() => setAttendance({ djangoattended: parseInt(djangoattended) + 1 })}>
                            Yes
                        </button>
