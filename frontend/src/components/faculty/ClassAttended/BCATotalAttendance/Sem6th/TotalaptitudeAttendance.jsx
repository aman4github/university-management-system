...
import { totalAttandanceBcaaptitude } from '../../../../../Services/faculty_api'
import '../../../../../style/login.css'
import Swal from "sweetalert2";

export default function TotalaptitudeAttendance() {
    useEffect(() => {
    ...
    const { id, aptitudeattended } = useParams();
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        await totalAttandanceBcaaptitude(attendance, id);
        Swal.fire({
            title: 'Success...',
            ...
            <div className="wrapper">
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="buttonsConfirmation">
                        <button type="submit" className="yesConfirm" onClick={() => setAttendance({ aptitudeattended: parseInt(aptitudeattended) + 1 })}>
                            Yes
                        </button>
