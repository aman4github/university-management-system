...
import { totalAttandanceBcamysql } from '../../../../../Services/faculty_api'
import '../../../../../style/login.css'
import Swal from "sweetalert2";

export default function TotalmysqlAttendance() {
    useEffect(() => {
    ...
    const { id, mysqlattended } = useParams();
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        await totalAttandanceBcamysql(attendance, id);
        Swal.fire({
            title: 'Success...',
            ...
            <div className="wrapper">
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="buttonsConfirmation">
                        <button type="submit" className="yesConfirm" onClick={() => setAttendance({ mysqlattended: parseInt(mysqlattended) + 1 })}>
                            Yes
                        </button>
