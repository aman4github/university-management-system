...
import { totalAttandanceBcaOs } from '../../../../../Services/faculty_api'
import '../../../../../style/login.css'
import Swal from "sweetalert2";

export default function TotalOsAttendance() {
    useEffect(() => {
    ...
    const { id, operatingsystemattended } = useParams();

    const [attendance, setAttendance] = useState({
        operatingsystemattended: "",
    });

    const onSubmit = async (e) => {
        e.preventDefault();
        await totalAttandanceBcaOs(attendance, id);
        Swal.fire({
            title: 'Success...',
            ...
            <div className="wrapper">
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="buttonsConfirmation">
                        <button type="submit" className="yesConfirm" onClick={() => setAttendance({ operatingsystemattended: parseInt(operatingsystemattended) + 1 })}>
                            Yes
                        </button>
