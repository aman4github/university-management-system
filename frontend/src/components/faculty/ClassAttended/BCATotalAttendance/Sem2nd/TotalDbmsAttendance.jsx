...
import { totalAttandanceBcaDbms } from '../../../../../Services/faculty_api'
...
export default function TotalDbmsAttendance() {
    ...
    const { id, dbmsattended } = useParams();
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        await totalAttandanceBcaDbms(attendance, id);
        Swal.fire({
            title: 'Success...',
            ...
            <div className="wrapper">
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="buttonsConfirmation">
                        <button type="submit" className="yesConfirm" onClick={() => setAttendance({ dbmsattended: parseInt(dbmsattended) + 1 })}>
                            Yes
                        </button>
