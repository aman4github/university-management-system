...
import { totalAttandanceBbasoftwarelab } from '../../../../../Services/faculty_api'
import '../../../../../style/login.css'
import Swal from "sweetalert2";

export default function TotalsoftwarelabAttendance() {
    useEffect(() => {
    ...
    const { id, softwarelabattended } = useParams();
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        await totalAttandanceBbasoftwarelab(attendance, id);
        Swal.fire({
            title: 'Success...',
            ...
            <div className="wrapper">
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="buttonsConfirmation">
                        <button type="submit" className="yesConfirm" onClick={() => setAttendance({ softwarelabattended: parseInt(softwarelabattended) + 1 })}>
                            Yes
                        </button>
