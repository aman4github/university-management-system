...
import { totalAttandanceBbabusinesslaw } from '../../../../../Services/faculty_api'
import '../../../../../style/login.css'
import Swal from "sweetalert2";

export default function TotalbusinesslawAttendance() {
    useEffect(() => {
    ...
    const { id, businesslawattended } = useParams();
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        await totalAttandanceBbabusinesslaw(attendance, id);
        Swal.fire({
            title: 'Success...',
            ...
            <div className="wrapper">
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="buttonsConfirmation">
                        <button type="submit" className="yesConfirm" onClick={() => setAttendance({ businesslawattended: parseInt(businesslawattended) + 1 })}>
                            Yes
                        </button>
