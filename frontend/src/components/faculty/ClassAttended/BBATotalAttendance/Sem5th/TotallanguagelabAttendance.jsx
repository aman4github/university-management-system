...
import { totalAttandanceBbalanguagelab } from '../../../../../Services/faculty_api'
import '../../../../../style/login.css'
import Swal from "sweetalert2";

export default function TotallanguagelabAttendance() {
    useEffect(() => {
    ...
    const { id, languagelabattended } = useParams();
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        await totalAttandanceBbalanguagelab(attendance, id);
        Swal.fire({
            title: 'Success...',
            ...
            <div className="wrapper">
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="buttonsConfirmation">
                        <button type="submit" className="yesConfirm" onClick={() => setAttendance({ languagelabattended: parseInt(languagelabattended) + 1 })}>
                            Yes
                        </button>
