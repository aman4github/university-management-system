...
import { totalAttandanceBhmsoftskills } from '../../../../../Services/faculty_api'
import '../../../../../style/login.css'
import Swal from "sweetalert2";

export default function TotalsoftskillsAttendance() {
    useEffect(() => {
    ...
    const { id, softskillsattended } = useParams();
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        await totalAttandanceBhmsoftskills(attendance, id);
        Swal.fire({
            title: 'Success...',
            ...
            <div className="wrapper">
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="buttonsConfirmation">
                        <button type="submit" className="yesConfirm" onClick={() => setAttendance({ softskillsattended: parseInt(softskillsattended) + 1 })}>
                            Yes
                        </button>
