...
import { totalAttandanceBhmnutrition } from '../../../../../Services/faculty_api'
import '../../../../../style/login.css'
import Swal from "sweetalert2";

export default function TotalnutritionAttendance() {
    useEffect(() => {
    ...
    const { id, nutritionattended } = useParams();
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        await totalAttandanceBhmnutrition(attendance, id);
        Swal.fire({
            title: 'Success...',
            ...
            <div className="wrapper">
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="buttonsConfirmation">
                        <button type="submit" className="yesConfirm" onClick={() => setAttendance({ nutritionattended: parseInt(nutritionattended) + 1 })}>
                            Yes
                        </button>
