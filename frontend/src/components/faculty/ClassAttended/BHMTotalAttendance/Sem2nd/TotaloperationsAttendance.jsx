...
import { totalAttandanceBhmoperations } from '../../../../../Services/faculty_api'
import '../../../../../style/login.css'
import Swal from "sweetalert2";

export default function TotaloperationsAttendance() {
    useEffect(() => {
    ...
    const { id, operationsattended } = useParams();
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        await totalAttandanceBhmoperations(attendance, id);
        Swal.fire({
            title: 'Success...',
            ...
            <div className="wrapper">
                <form onSubmit={(e) => onSubmit(e)}>
                    ...
                    <div className="buttonsConfirmation">
                        <button type="submit" className="yesConfirm" onClick={() => setAttendance({ operationsattended: parseInt(operationsattended) + 1 })}>
                            Yes
                        </button>
